        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-pro"> <a href="javascript:void(0)" aria-expanded="false"><i class="icon-user"></i> Admin</a>

                        </li>
                        <li class="nav-small-cap">--- NAVIGATION</li>
                        <li> <a href="{{ route('admindashboard') }}" aria-expanded="false"><i class="icon-home"></i>Dashboard</a></li>
                        <li> <a href="{{ route('admincourse') }}" aria-expanded="false"><i class="icon-note"></i>Courses</a></li>
                        <li> <a href="{{ route('adminlesson') }}" aria-expanded="false"><i class="icon-book-open"></i>Lesson</a></li>
                        <li> <a href="{{ route('admintrainee') }}" aria-expanded="false"><i class="icon-people"></i>Trainees</a></li>
                        <li> <a href="{{ route('adminfeedback') }}" aria-expanded="false"><i class="icon-speech"></i>Feedbacks</a></li>
                    </ul>
                </nav>
